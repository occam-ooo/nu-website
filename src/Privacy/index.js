  ...
  render() {
    return (
      <div className='Privacy-container'>
        ...
        <div>
          {' '}
          <h1>Privacy Policy of <strong>Nu - Events. Today.</strong></h1>
          {' '}
          ...
          <h3>Events</h3>
          {' '}
          <p>Provides access to the list of events the User is attending.</p>
          {' '}
          ...
          {' '}
          <p> Permissions asked: Contact email, Events and Friends' Events. </p>
          {' '}
          <p>
            {' '}
          ...
          {' '}
          <p>AdMob is an advertising service provided by AdMob Google Inc.</p>
          {' '}
